          ...
          <>
            ...
            <div className="bg-gradient-to-r from-teal-700 via-emerald-600 to-cyan-700 rounded-3xl p-8 text-white shadow-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
              ...
              <button
                ...
                className="bg-amber-400 hover:bg-amber-500 text-slate-900 font-extrabold text-sm px-6 py-3.5 rounded-2xl shadow-lg transition transform hover:scale-105 whitespace-nowrap"
              >
                ➕ Post Home Surplus Food
              </button>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-2xl shadow-md p-8 border border-gray-100">
                ...
                {dashboardData.my_donations.length === 0 ? (
                  <div className="text-center py-10 text-gray-500">
                    ...
                    <p className="text-sm font-medium">You haven't posted any home food donations yet.</p>
                    <button
                      onClick={() => setIsModalOpen(true)}
              ...
              <div className="bg-white rounded-2xl shadow-md p-8 border border-gray-100">
                <h3 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                  🤝 Nearby Verified NGOs & Food Banks
                </h3>
